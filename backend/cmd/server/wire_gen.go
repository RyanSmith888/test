...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountHealthHandler := admin.NewAccountHealthHandler(gatewayService, adminService)
	...
	translationService := service.ProvideTranslationService(configConfig, redisClient)
	gatewayHandler := handler.NewGatewayHandler(gatewayService, geminiMessagesCompatService, antigravityGatewayService, userService, concurrencyService, billingCacheService, usageService, apiKeyService, usageRecordWorkerPool, errorPassthroughService, userMessageQueueService, configConfig, settingService, translationService)
